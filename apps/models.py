...
from django.db.models import Model, DateTimeField, CharField, SlugField, ForeignKey, CASCADE, DecimalField, \
    IntegerField, TextChoices, DateField, ImageField, BooleanField
